...
def recognize_digits(frame):
    ...
    try:
        ...
        identified_digits = []  # List to store identified digits
        ...
        for c in contours:
            ...
            if w > MIN_DIGIT_WIDTH and h > MIN_DIGIT_HEIGHT and w < MAX_DIGIT_WIDTH and h < MAX_DIGIT_HEIGHT:
                ...
                if MIN_DIGIT_ASPECT <= aspect_ratio <= MAX_DIGIT_ASPECT:
                    ...
                    # Less Agressive Try
                    thresh = cv2.adaptiveThreshold(roi, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV,
                                                  11, 5)  # Less agressive  the C Value is now 5 instead of 2
                    ...
                    try:
                        ...
                        text = pytesseract.image_to_string(inverted_thresh,
                                                            config=TESSERACT_CONFIG)  # To OCR process using correct whitelist
                        ...
                        if len(text) == NUMBER_LENGTH and text.isdigit():
                            ...
                            identified_digits.append(text) #Append
                            ...
                            try:
                                ...
                                if response.status_code == 200:
                                    ...
                                    cv2.putText(frame, student_name, (x, y + h + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                                                (0, 255, 0), 2)
        ...
        while True:
            ...
            if frame_count % FRAME_INTERVAL == 0:
                if detect_motion(frame1, frame2):
                    ...
                    digits = recognize_digits(frame2)
                    if digits:
                        print(digits)
